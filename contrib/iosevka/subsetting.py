...
def program(  # noqa: PLR0913
    ...
    force: Annotated[
        ...
        typer.Option(
            "--force",
            "-f",
            help="Force the generation of font subsets, "
...
class TasksSuite:
    ...
    def dry_run(self):
        ...
        and a list of output files that would be generated for such the input.
        """
...
class CSSValues:
    ...
    def __format__(self, format_spec: str) -> str:
        if format_spec == "css":
            return (
                f"font-stretch: {self.width}; "
                f"font-weight: {self.weight}; "
                f"font-style: {self.slope};"
            )
...
class FontStyleParser:
    ...
    def get_indices(self, width_key: str, weight_key: str, slope_key: str) -> tuple[int, int, int]:
        """
