import Highlight from "../base/Highlight.astro";
import Muted from "../base/Muted.astro";
import Bole from "./Bole.astro";
import IPATranscript from "./IPATranscript.astro";


## Interests and Hobbies

First, let’s get this out of the way:
I am a furry <Dim>(yeah, I hope it’s obvious by now)</Dim>.
...
- <Highlight>Doujins? Merchandises?</Highlight>
  I have a modest collection of approximately a hundred doujinshi <Muted>so far</Muted>,
...
- I’m a big nerd, <Dim>_literally_ and _figuratively_</Dim>:
...
- I like to travel abroad and tread on off-beaten paths.
  ...
  I’ve been spending at least one night at the following places <Dim>(in alphabetical order)</Dim>:
...
- I’m a dog person <Dim>(surprise, surprise)</Dim>.
...
<div class="dimmed mx-6 text-sm/6">
...
His name holds a little-known story. <Bole /> was born prematurely, his body
