...
pelage consists of *four* primary colors: <span class="px-px text-beetroot not-print:bg-black">Beetroot</span>, <span class="px-px text-orange not-print:bg-black">Orange</span>, <span class="px-px text-lemon not-print:bg-black">Lemon</span>, and <span class="px-px text-eggplant not-print:bg-black">Eggplant</span>.
