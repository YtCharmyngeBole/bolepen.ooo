...
<span class="bole">*That* Charming BOLE</span>. Despite being a dog, this
auspicious name derives from the Middle English word for a young heraldic bull
...
<span class="bole before:content-[open-quote] after:content-[close-quote]">
  <span class="px-px">YtCharmyngeBole</span>
</span>
...
<span class="px-px text-custom-beetroot bg-black">Beetroot</span>,
<span class="px-px text-custom-orange bg-black">Orange</span>,
<span class="px-px text-custom-lemon bg-black">Lemon</span>, and
<span class="px-px text-custom-eggplant bg-black">Eggplant</span>.
...
<IosevkaLigature feature="none">
  ```rfc7468 frame=none
  -----BEGIN FURRY CODE BLOCK----- FCM3asw A->++ C+ D?
