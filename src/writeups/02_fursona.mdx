...
import LigatureSettings from "#components/LigatureSettings.astro";
...
<Muted>_More information in the Character Sheet section_ (_coming soon_).</Muted>
...
- **Favorite color:** Green <Muted>(who would’ve guessed?)</Muted>
- **Hobbies:** Lying around, Belly rubs, and Working out <Muted>(or at least immensely thinking about it)</Muted>
...
<Muted>_More information are more to come soon._</Muted>
