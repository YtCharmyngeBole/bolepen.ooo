...
<div class="smallnote">
  ...
  <span class="ipa">/ˈbɔːl(ə)/</span> (see
...
<span class="bole">BOLE</span> was born prematurely,
his body frail and vulnerable to the slightest breeze.
...
<span class="bole">BOLE</span>is a dog but with one striking feature:
...
His soft pelage consists of *four* primary colors:
...
<span class="bole">BOLE</span> can transform into other shapes
(e.g. buff, lean, or anything in between)
with the magical power of *commissioned artworks*.

<span class="muted">*More information in the Character Sheet section* (*coming soon*).</span>
