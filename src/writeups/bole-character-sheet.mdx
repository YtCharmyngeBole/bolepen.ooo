...
- **Colors**:
  <span class="px-px text-beetroot not-print:bg-black"><span class="iconify mingcute--square-fill iconify-inline" /> Beetroot</span>,
  <span class="px-px text-orange not-print:bg-black"><span class="iconify mingcute--square-fill iconify-inline" /> Orange</span>,
  <span class="px-px text-lemon not-print:bg-black"><span class="iconify mingcute--square-fill iconify-inline" /> Lemon</span>, and
  <span class="px-px text-eggplant not-print:bg-black"><span class="iconify mingcute--square-fill iconify-inline" /> Eggplant</span>.
